  ...
  return (
    <>
      ...
      <Container>
        ...
        <Bio>
          I'm a full-stack software developer based out of Seattle. A long-time
          lover of logic puzzles, pattern-matching, and storytelling, I bring
          strong backend capabilities and a keen eye for frontend design to
        ...
        <Bio>
          ...
          History and minored in English. More recently, I graduated the Grace
